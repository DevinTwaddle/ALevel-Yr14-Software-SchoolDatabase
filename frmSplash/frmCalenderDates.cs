...
namespace frmSplash
{
    public partial class frmCalenderDates : Form
    {
        ...
        private void monthCalendar1_DateChanged(object sender, DateRangeEventArgs e)
        {
            ...
            // Then with the use of substrings, it is possible to individually assign values to global variables.
        ...
        private void ScheduleCalendar_DateSelected(object sender, DateRangeEventArgs e)
        {
            ...
            {
                MessageBox.Show("Private classes are unavailable during Summer Months");
            }
